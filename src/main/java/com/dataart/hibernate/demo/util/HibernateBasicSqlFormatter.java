...
public class HibernateBasicSqlFormatter implements MessageFormattingStrategy {
    ...
    private final Formatter basicFormatter = new BasicFormatterImpl();
    private final Formatter noFormatter = source -> source;
    ...
    public String formatMessage(int connectionId, String now, long elapsed, String category, String prepared,
        ...
        return String.format(template, batch, noFormatter.format(res), elapsed);
    }
}
